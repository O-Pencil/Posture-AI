/**
 * @file AppDelegate.mm
 * @description iOS 端 RN 宿主 AppDelegate 实现，设置 moduleName="Catune" + 空 initialProps，返回 bundleURL。
 *
 ...
 * [HERE] ios/Catune/AppDelegate.mm · iOS RN 宿主实现（脚手架）
 */
